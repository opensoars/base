...
/*
    '16': function (b2){
      ...
      var rev_half_octet, half_octet_b10 = 0;
      for(var i=0; i<b2.length; i+=4){
        rev_half_octet = b2.substr(i, 4).split('').reverse();
        half_octet_b10 = 0;
        for(var b_i=0; b_i<rev_half_octet.length; b_i+=1)
          half_octet_b10 += rev_half_octet[b_i] * Math.pow(2, b_i);

        b16 = b16 + MAP16[half_octet_b10];
      }
